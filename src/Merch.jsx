...
const Merch = () => {
  ...
  const products = {
    ...
    shirts: [
      ...
      { id: 22, ame: 'Steel and Shadows Graphic Shrirt', price: '59.99', description: "Featuring a soft, smooth modal blend, this shirt delivers exceptional comfort. Its silky feel and moisture-absorbing properties make it perfect for warm-weather wear.", image: 'shirt5.png', isMeasureable: true },
      ...
      { id: 24, name: 'Room For House Shirt', price: '35.99', description: "Crafted with a touch of Lycra for added stretch, this shirt provides comfort and flexibility. Perfect for both work and play, it moves with you while maintaining a sleek look.", image: 'shirt7.png',  isMeasureable: true },
    ...
    <div className="relative h-[400px] bg-pageBlack">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <h1 className="text-white text-7xl font-bold font-metal"
          style={{ textShadow: "0 0 5px #001834, 0 0 10px #001834, 0 0 30px #7beaf0, 0 0 40px #7beaf0" }}>
          Merch Collection
        </h1>
      </div>
    </div>
    ...
    <div className="space-y-4 bg-pageBlack text-black">
      ...
      <section id="bestSellers" className="scroll-mt-24 text-white">
        ...
        <h2 className="text-4xl font-bold text-left ml-[100px] text-white font-fancy mb-2"
          style={{ textShadow: "0 0 10px #04d9ff, 0 0 30px #04d9ff, 0 0 40px #04d9ff" }}>
          Best Sellers
        </h2>
          ...
          {products.bestSellers.map((product) => (
            ...
            >
              <img
                src={product.image}
                alt={product.name}
                className="w-full h-auto max-w-full aspect-square object-cover mb-4"
              />
              <p className="font-bold text-m text-left font-fancy ml-[65px]"
                style={{ textShadow: "0 0 3px #001834, 0 0 5px #001834, 0 0 10px #04d9ff, 0 0 20px #249ed6" }}>
                {product.name}
              </p>
          ...
          {products.albums.map((album) => (
            ...
            >
              <img
                src={album.image}
                alt={album.name}
                className="w-full h-auto max-w-full aspect-square object-cover mb-5"
              />
          ...
          {products.shirts.map((shirt) => (
            ...
            >
              <img
                src={shirt.image}
                alt={shirt.name}
                className="w-full h-auto max-w-full aspect-square object-cover mb-2"
              />
              <p className="font-bold text-m text-left font-fancy ml-[55px]"
                style={{ textShadow: "0 0 3px #001834, 0 0 5px #001834, 0 0 10px #04d9ff, 0 0 20px #249ed6" }}>
                {shirt.name}
