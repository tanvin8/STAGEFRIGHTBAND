    ...
    <div className="bg-black text-white min-h-screen font-sans">
      ...
      <div className="relative bg-[url('/fanclub.png')] bg-cover bg-center h-[70vh] flex items-center justify-center">
        <div className="text-center drop-shadow-2xl px-8 py-12 rounded-lg">
          <h1 className="text-6xl font-extrabold uppercase mb-4 tracking-wider text-red-800" style={{ textShadow: "2px 2px 4px rgba(0, 0, 0)" }}>
            The Fright Club
          </h1>
          <p className="text-xl font-medium text-red-800" style={{ textShadow: "2px 2px 8px rgba(0, 0, 0)" }}>
      ...
      <section className="bg-gradient-to-b from-gray-900 via-black to-gray-900 py-16 px-8">
