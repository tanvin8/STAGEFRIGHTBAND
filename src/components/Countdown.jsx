...
const Countdown = () => {
  ...
  return (
    <div className="bg-pageBlack text-center">
      ...
      <div>
      <Link to="/merch">
        <button className = "text-white font-semibold text-[20px] mb-[60px]">View All →</button>
        </Link>
      </div>
      {/* tour dates*/}
      <div>
        ...
        <div className="flex flex-col mx-4 md:mx-20 lg:mx-40 mt-10">
          ...
          <button>
          <Link to = "/tours">
            <div className="bg-navRed p-4 rounded-md mb-4 text-white ">
          ...
          <div className="flex justify-center">
            <Link to="/tours">
              <button className="text-white text-base md:text-xl font-semibold mt-5 border-white px-4 py-2 max-w-[120px]">
                See All →
              </button>
            </Link>
          </div>
      ...
      {/* app promo */}
      <div className="mt-10 bg-navRed p-4 md:p-8">
