...
const Cart = () => {
  ...
  const closeModal = () => {
    setCartItems([]); // Reset the cartItems state
    setBillingDetails({
      cardNumber: '',
      expiryDate: '',
      cvv: '',
  ...
  return (
    <div className="text-center bg-pageBlack text-white">
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="lg:w-1/2 ml-16">
          ...
          <h2 className="py-2 text-2xl font-bold mt-[0px]">Shipping Details</h2>
